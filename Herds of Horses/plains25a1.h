...
class Plains {
private:
    AVLTree<std::shared_ptr<Horse>, HorseSharedPtrComparator>* allHorses;
    AVLTree<std::shared_ptr<Horse::HorseLink>, HorseSharedLinkPtrComparator>* allLinks;
    AVLTree<std::shared_ptr<Herd>, HerdSharedPtrComparator>* fullHerds;
    AVLTree<std::shared_ptr<Herd>, HerdSharedPtrComparator>* emptyHerds;
